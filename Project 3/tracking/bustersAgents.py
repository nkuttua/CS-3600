...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        top_action = None
        for i in legal:
            curr_successor = Actions.getSuccessor(pacmanPosition, i)
            dist_2_successor = self.distancer.getDistance(curr_successor, target)
            if dist_2_successor < min_dist:
                min_dist = dist_2_successor
                top_action = i
